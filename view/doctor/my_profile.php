                    ...
                    <form method="POST" action="http://localhost/clinic1/controller/UserController.php">
                        <div class="mp-grid">
                            <div class="mp-field">
                                ...
                                <input type="text" name="first_name" value="<?php echo htmlspecialchars($doctor_info['first_name']); ?>" required>
                            </div>
                            <div class="mp-field">
                                <label>Last Name</label>
                                <input type="text" name="last_name" value="<?php echo htmlspecialchars($doctor_info['last_name']); ?>" required>
                            </div>
                            <div class="mp-field">
                                <label>Email</label>
                            ...
                            <div class="mp-field">
                                ...
                                <input type="text" value="<?php echo htmlspecialchars($doctor_info['license_number']); ?>" readonly>
                            </div>
                            <div class="mp-field">
                                <label>Schedule</label>
                                <input type="text" value="<?php echo htmlspecialchars($doctor_info['schedule_days'] . ' • ' . $doctor_info['schedule_time_start'] . ' - ' . $doctor_info['schedule_time_end']); ?>" readonly>
                            </div>
                        </div>
